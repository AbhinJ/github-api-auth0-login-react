      ...
      return(
        <section className="github-profile">
          <div className="github-profile-info">
            <a href={userdata.homeUrl} target="_blank" title={userdata.name || userdata.username}><img src={userdata.avatar} alt={userdata.username}/></a>
            <h2><a href={userdata.homeUrl}>{userdata.name || userdata.username}</a></h2>
          </div>
